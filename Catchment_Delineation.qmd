...
```{r}
excel_file <- "../../Data/Muttama/Data/Hydrology/LocationsStreamSites.xlsx"
getwd()
output_shapefile <- "../../Data/Muttama/GIS/Hydrology/StreamSites.shp"
```
...
```{r}
bbox_coords <- c(xmin = 149.0, ymin = -31.50, xmax = 151.5, ymax = -29.5)
...
# Plot to visualize
plot(dem)
writeRaster(dem, "../../Data/GIS/Terrain/demh.tif", overwrite = TRUE)
```
...
```{r}
# Define file paths
input_dem <- "../../Data/GIS/Terrain/demh.tif"  # Replace with the path to your DEM file
#proj_dem <- "./GIS/Terrain/1_Second_DSMwgs.tif"  # Replace with the path to your DEM file
pour_points_file <- "../../Data/GIS/Hydrology/StreamSites.shp"  # Replace with your pour points shapefile
